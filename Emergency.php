...
<div class="logo-container">
 ...
 <a href="spa.php?page=regulations" class="sidebar-nav-item" id="nav-events">
    ...
    <div class="dynamic-header emergency-header">
        ...
        <h2 data-i18n="emergency_title">🆘 Emergency Services</h2>
    </div>
    
    <div class="emergency-grid">
        <button class="emergency-btn red">
            <div class="icon">🚑</div>
            <h3 data-i18n="ambulance">Ambulance</h3>
            <p class="number">123</p>
        </button>
        
        <button class="emergency-btn orange">
            <div class="icon">🚒</div>
            <h3 data-i18n="fire_dept">Fire Department</h3>
            <p class="number">125</p>
        </button>
        
        <button class="emergency-btn blue">
            <div class="icon">👮</div>
            <h3 data-i18n="police">Police</h3>
            <p class="number">911</p>
        </button>
        
        <div class="hospital-card">
            <h3 data-i18n="nearest_hospital">🏥 Nearest Hospital</h3>
            <p data-i18n="city_hospital">City General Hospital</p>
            <p data-i18n="miles">1.2 miles away</p>
            <button class="general-btn" data-i18n="get_directions">Get Directions</button>
        </div>
    </div>
    </div>
