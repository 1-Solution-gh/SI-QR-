    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const menuData = [
                ...
                { href: 'Jobs.php', icon: 'fa-solid fa-briefcase', title: 'Jobs & Gigs', message: 'Browse all Jobs in the city.' },
                { href: 'Transport.php', icon: 'fas fa-car', title: 'Transportation', message: 'Check and Understand Transport in the city.' },
                { href: 'Emergency.php', icon: 'fa-solid fa-hospital', title: 'Emergency/Hospital', message: 'Get Emergency Helps here.' },
