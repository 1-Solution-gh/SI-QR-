...
<div class="logo-container">
 ...
 <a href="spa.php?page=regulations" class="sidebar-nav-item" id="nav-events">
    ...
    <div class="dynamic-header">
        ...
        <h2 data-i18n="transportation_title">🚍 Transportation</h2>
    </div>
    
    <div class="transport-tabs">
        <button class="tab active" data-i18n="public_transit">Public Transit</button>
        <button class="tab" data-i18n="taxis">Taxis</button>
        <button class="tab" data-i18n="bike_sharing">Bike Sharing</button>
    </div>
    
    <div class="map-container">
        <img src="img/maps.jpg" alt="Transport Map">
    </div>
    ...
    <div class="transport-options">
        <div class="option">
            <div class="icon">🚇</div>
            <div>
                <h3 data-i18n="metro_line1">Metro Line 1</h3>
                <p data-i18n="every_10_mins">Runs every 10 mins</p>
            </div>
        </div>
        <div class="option">
            <div class="icon">🚌</div>
            <div>
                <h3 data-i18n="bus_route42">Bus Route 42</h3>
                <p data-i18n="to_downtown">To Downtown</p>
            </div>
        </div>
    </div>
    </div>
